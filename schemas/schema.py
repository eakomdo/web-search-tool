...
class SearchResponse(BaseModel):
    ...
    total_results: int = Field(default=0, description="Total number of results available")
    search_time_ms: float = Field(default=0, description="Time taken to search in milliseconds")
